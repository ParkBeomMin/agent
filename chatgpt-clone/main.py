    ...
    st.session_state["agent"] = Agent(
        ...
        instructions="""
            ...
            You have access to the following tools:
                ...
                - File Search Tool: Use this when the user asks a questions that isn't in your training data. Use this to learn about the user's files.
        """,
        tools=[WebSearchTool(),
        FileSearchTool(
            vector_store_ids=[
...
def update_status(status_container, event):
    status_messages = {
        # "name of the event": ("Searching the web...", "running"),
        # "completed event": ("Search completed", "complete"),
...
if prompt:
    ...
    # 파일 먼저 처리되어야 이후 질문에 대해서 대답할 수 있음
